import { _ as a, o as n, c as s, d as e } from './app.559f79f4.js';
const t = {},
  o = e(
    `<h1 id="prettier" tabindex="-1"><a class="header-anchor" href="#prettier" aria-hidden="true">#</a> Prettier</h1><h2 id="使用" tabindex="-1"><a class="header-anchor" href="#使用" aria-hidden="true">#</a> 使用</h2><ol><li>通过 <code>npm</code> 或 <code>yarn</code> 等包管理工具下载 <code>prettier</code> 配合 <code>eslint</code> 使用</li><li>在文件根目录中创建 <code>.prettierrc</code> 文件，配合 vscode 使用</li></ol><h2 id="规则说明" tabindex="-1"><a class="header-anchor" href="#规则说明" aria-hidden="true">#</a> 规则说明</h2><h3 id="print-width" tabindex="-1"><a class="header-anchor" href="#print-width" aria-hidden="true">#</a> Print Width</h3><div class="language-json" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
