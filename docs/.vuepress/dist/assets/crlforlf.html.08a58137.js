...
*.tsx text eol=lf
*.d.ts text eol=lf
</code></pre></div><p>将需要变换的文件格式写上即可</p><p>虽然具备两种方案。但还是推荐两种方案结合使用，避免产生不必要的问题。</p>`,14),s=[t];function l(d,i){return a(),o("div",null,s)}const p=e(n,[["render",l],["__file","crlforlf.html.vue"]]);export{p as default};
