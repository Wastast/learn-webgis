    ...
    if (Common.isUndefined(params.parent)) {
      if (autoPlaceVirgin) {
        ...
        if (params.parentNode) {
          dom.addClass(autoPlaceContainer, GUI.CLASS_AUTO_PARENT_NODE);
          params.parentNode.appendChild(autoPlaceContainer);
        } else {
